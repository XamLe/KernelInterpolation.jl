...
many_nodes = homogeneous_hypercube(400, x_min, x_max; dim = d)
f_many = f.(many_nodes)
...
kernels = [
    GaussKernel{d}(),
    # MultiquadricKernel{d}(),
    InverseMultiquadricKernel{d}(),
    # ThinPlateSplineKernel{d}(), PolyharmonicSplineKernel{d}(3),
    WendlandKernel{d}(0),
